...
<!--[if gt IE 8]><!--> <html lang="en" ng-app="ensApp" class="no-js" ng-controller="MainCtrl"> <!--<![endif]-->
    <head>
        ...
        <title ng-bind="systemName + '- Notification System'">Message360 Notification System</title>
        ...
        <script>
            var firebaseDomain = '<?php echo $firebaseDomain; ?>';
        </script>
    </head>
    ...
    <md-toolbar md-scroll-shrink ng-if="true">
        <div layout class="md-toolbar-tools">
            ...
            <h3>
                <span>{{systemName}} - Notification System</span>
            </h3>
            <span flex></span>
    ...
    <section layout="row" flex>
        ...
        <md-sidenav class="md-whiteframe-z2" md-component-id="left" md-is-locked-open="$mdMedia('gt-sm')">
            <md-content layout="column" layout-padding layout-fill>
                ...
                <img src="http://message360.com/wordpress/wp-content/uploads/2015/12/logo.png" width="50%">
            </md-content>
        </md-sidenav>
